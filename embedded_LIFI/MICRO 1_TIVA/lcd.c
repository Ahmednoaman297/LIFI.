 ...
 */
void intToString(uint32 value, uint8 *buffer, uint32 bufferSize) {
...
{
   uint8 buff[32]; /* String to hold the ascii result */
   intToString(data,buff,10); /* Use itoa C function to convert the data to its corresponding ASCII value, 10 for decimal */
